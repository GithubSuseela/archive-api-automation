@ignore
#Tested by TDPTF-1169
Feature: As a tda client, I want to Export td lines (Vehicle) into csv format

  Background:
    * url api_url
    * configure headers = read('classpath:headers.js')

  Scenario: POST - 200 - Export td lines (Vehicle) into csv format
...
#   POST - Export Vehicle TD lines
    ...
    * configure headers = globalHeaders
    Given path '/api/v1/technical-definitions/', tdId, '/vehicle-lines/export'
